...
namespace Logica.wsaaProduccion {
    ...
    public interface LoginCMS {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(Logica.wsaaProduccion.LoginFault), Action="", Name="fault")]
        Logica.wsaaProduccion.loginCmsResponse loginCms(Logica.wsaaProduccion.loginCmsRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LoginCMSChannel : Logica.wsaaProduccion.LoginCMS, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LoginCMSClient : System.ServiceModel.ClientBase<Logica.wsaaProduccion.LoginCMS>, Logica.wsaaProduccion.LoginCMS {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Logica.wsaaProduccion.loginCmsResponse Logica.wsaaProduccion.LoginCMS.loginCms(Logica.wsaaProduccion.loginCmsRequest request) {
            return base.Channel.loginCms(request);
        }
        
        public string loginCms(string in0) {
            Logica.wsaaProduccion.loginCmsRequest inValue = new Logica.wsaaProduccion.loginCmsRequest();
            inValue.in0 = in0;
            Logica.wsaaProduccion.loginCmsResponse retVal = ((Logica.wsaaProduccion.LoginCMS)(this)).loginCms(inValue);
